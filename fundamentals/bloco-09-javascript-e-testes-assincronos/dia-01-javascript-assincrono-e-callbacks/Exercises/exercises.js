 ...
 * Logo, adicione na função sendMarsTemperature uma callback que contenha as ações a serem tomadas em 
 * cima da temperatura. */
...
// const sendMarsTemperature = (callback) => {
//   const temperature = Math.floor(toFahrenheit(getMarsTemperature()));
 ...
 * adicione na função sendMarsTemperature uma outra callback que contenha as ações 
...
/** 7 - Escreva um teste que verifique a chamada da callback de uma função uppercase , que transforma as letras 
 ...
 * disponíveis: Bulbasaur, Charmander e Squirtle. Complete a chamada da função getPokemonDetails 
 * de modo que ela retorne os detalhes do pokémon que você escolheu. 
 * PS: é possível que o sistema do Professor Carvalho apresente erros, então não se esqueça 
 * de tratá-los também, combinado? */
