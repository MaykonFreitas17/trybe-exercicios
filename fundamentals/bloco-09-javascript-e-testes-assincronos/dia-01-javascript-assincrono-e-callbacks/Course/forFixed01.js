 ...
 * Para fixar
 * 
 * Lembre-se: quando definimos uma função, o parâmetro pode ter qualquer nome, porém, ao fazer a execução/chamada 
 * dessa função, o parâmetro deve ser um valor definido. No nosso caso, vamos utilizar uma função como 
 * parâmetro ( callback ).
 ...
 * Complete a função getUser de forma que ela receba uma função callback como parâmetro para realizar as 
 * operações abaixo:
 * 
