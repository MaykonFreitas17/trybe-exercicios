...
function fantasyOrScienceFiction(array) {
  ...
  array.sort((a, b) => (a.releaseYear - a.author.birthYear) - (b.releaseYear - b.author.birthYear));
  const obj = array.map((element) => ({
...
const newArray = fantasyOrScienceFiction(books);
